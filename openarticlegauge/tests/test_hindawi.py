...
from openarticlegauge.plugins.hindawi import HindawiPlugin as MyPlugin

# a list of urls which your plugin should be able to support
SUPPORTED_URLS = ["http://www.hindawi.com/journals/ijrm/2004/576764/abs/",
                  "http://www.hindawi.com/journals/ecam/2013/429706/"]
...
RESOURCE_AND_RESULT = {
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "resources", "10.1155-2013-429706.html") : 
        {
            ...
            "url": 'http://creativecommons.org/licenses/by/3.0', # CC BY 3.0 license link
            "provenance": {
                "handler": 'hindawi', # name of plugin which processed this record
