...
class TestWorkflow(TestCase):
    ...
    def test_06_bmc_standard_OA_license2(self):
    	# Same as above but with a space in the license link text
        bmc = BMCPlugin()
        
        record = {}
        record['bibjson'] = {}
        record['provider'] = {}
        record['provider']['url'] = ['http://www.biomedcentral.com/1471-2458/13/1092']
        record = models.MessageObject(record=record)
    ...
    def test_06_bmc_standard_OA_license3(self):
    	# Same as top but with 'credited' instead of cited
        bmc = BMCPlugin()
        
        record = {}
        record['bibjson'] = {}
        record['provider'] = {}
        record['provider']['url'] = ['http://www.ijbnpa.org/content/11/1/34']
        record = models.MessageObject(record=record)
