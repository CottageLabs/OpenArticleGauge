...
#
RESOURCE_AND_RESULT = {
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "resources", "bmc_10.1186_1471_1471-2164-13-425.html"):
        {
            ...
            "SA": False,
            "provenance": {
                "handler": 'bmc', # name of plugin which processed this record
                ...
                "source": "http://www.biomedcentral.com/1471-2164/13/425", # source is the url where we look this record up
                "date": -1 # date is not null (but we don't know the exact value)
            }
        },
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "resources", "bmc_10.1186_1471-2458-13-1092.html"):
        {
            "id" : None,            # there should be no id field
            "version": "2.0",          # version should be the empty string
            "type": "cc-by",
            ...
            "provenance": {
                ...
                "agent": config.agent, # agent is from configuration
                "source": "http://www.biomedcentral.com/1471-2458/13/1092", # source is the url where we look this record up
                "date": -1 # date is not null (but we don't know the exact value)
            }
        },
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "resources", "bmc_10.1186_1479-5868-11-34.html"):
        {
            "id" : None,            # there should be no id field
            "version": "2.0",          # version should be the empty string
            "type": "cc-by",
            ...
            "provenance": {
                ...
                "agent": config.agent, # agent is from configuration
                "source": "http://www.ijbnpa.org/content/11/1/34", # source is the url where we look this record up
                "date": -1 # date is not null (but we don't know the exact value)
            }
        },
