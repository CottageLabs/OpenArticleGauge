...
celery multi start 7 -A openarticlegauge.slavedriver -l debug --pidfile=%n.pid --logfile=%n.log -Q:1-3 detect_provider -Q:4-6 provider_licence -Q:7 store_results
