...
from isitopenaccess.plugins import elife
...
class TestWorkflow(TestCase):
    ...
    def test_01_bad_bad_fixme_todo_asap_standard_OA_license(self):
        record = {}
        record['bibjson'] = {}
        record['identifier'] = {'id': '10.7554/eLife.00160', 'type': 'doi'}

        elife.page_license(record)
...
#    def test_05_standard_OA_license(self):
#        record = {}
#        record['bibjson'] = {}
#        record['provider'] = {}
